<template>
  <div class="home">
    <!--<ul :class="asideClose ? 'menu_list menu_list_close':'menu_list menu_list_Open'" @mouseenter="handleMouseenter" @mouseleave="handleMouseleave">
      &lt;!&ndash;<li :class="belong === '1' ?'active_menu': ''" @click="menuSelect('1')"><span class="huo_dong"></span>{{asideClose?' ':'社团'}}</li>&ndash;&gt;
     &lt;!&ndash; <li :class="belong === '2' ?'active_menu': ''" @click="menuSelect('2')"><span class="she_tuan"></span>{{asideClose?' ':'活动'}}</li>&ndash;&gt;
      &lt;!&ndash;<li :class="belong === '3' ?'active_menu': ''" @click="menuSelect('3')"><span class="xiao_xi"></span>{{asideClose?' ':'消息'}}</li>&ndash;&gt;
    </ul>-->
